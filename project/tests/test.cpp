...
TEST(Check_person, no_parameters) {
    ...
    char empty[2] = "\n";
    EXPECT_TRUE(check_person(&person, empty, empty, empty) == 0);
    free(person.name);
    free(person.surname);
    free(person.role);
}
...
TEST(Check_person, not_all_parameters) {
    ...
    char name[20] = "Ilya";
    char name2[20] = "Alex";
    EXPECT_TRUE(check_person(&person, empty, empty, role) == 0);
    EXPECT_TRUE(check_person(&person, name, empty, role) == 0);
    EXPECT_TRUE(check_person(&person, empty, surname, role) == 0);
    EXPECT_TRUE(check_person(&person, empty, empty, role2) == NO_PERSON_FOUND);
    EXPECT_TRUE(check_person(&person, name2, empty, role2) == NO_PERSON_FOUND);
    EXPECT_TRUE(check_person(&person, empty, surname2, role2) == NO_PERSON_FOUND);
    free(person.name);
    free(person.surname);
    free(person.role);
}
